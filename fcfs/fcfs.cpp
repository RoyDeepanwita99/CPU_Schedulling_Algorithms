...
int main(){
   ...
   cout<< "process"<<"           "<<"rT"<<"          "<<"ct"<<"            "<<"wt"<<"             "<<"tat"<<endl;
    for(int n=0;n<numOfProcesses;n++){
       ...
       cout << "\nProcess " << processes[n].processName <<"            "<<processes[n].responseTime <<"           "<<processes[n].completionTime<<"              "<<processes[n].waitingTime <<"          "<<processes[n].turnAroundTime<<endl;
